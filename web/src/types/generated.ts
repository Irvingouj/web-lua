 ...
 */
export type AsyncCommand = { call_id: number, action: string, params: any, };
 ...
 */
export type RunResult = { stdout: Array<string>, stderr: Array<string>, result: string | null, error: CellError | null, commands: any[], fuel_exhausted: boolean, execution_count: number, status: CellStatus, pending_command: AsyncCommand | null, };
