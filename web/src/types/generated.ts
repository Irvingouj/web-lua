 ...
 */
export type CellError = { "kind": "compile", message: string, line: number | null, } | { "kind": "runtime", message: string, line: number | null, } | { "kind": "strict_mode", variable: string, } | { "kind": "fuel_exhausted" } | { "kind": "internal", message: string, } | { "kind": "cancelled" };
...
export type FetchDomParams = { url: string, selector: string, max_text: bigint, };
...
export type PageExtractParams = { fields: Array<string>, max_text: bigint, max_headings: bigint, max_links: bigint, };
