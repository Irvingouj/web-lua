...
export class WasmSession {
    ...
    load_library(source) {
        ...
        try {
            ...
            const ret = wasm.wasmsession_load_library(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
    ...
    run_cell(code, stdin) {
        ...
        try {
            ...
            const ret = wasm.wasmsession_run_cell(this.__wbg_ptr, ptr0, len0, ptr1, len1);
            deferred3_0 = ret[0];
            deferred3_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    set_fuel_limit(limit) {
        wasm.wasmsession_set_fuel_limit(this.__wbg_ptr, limit);
    }
}
